...
vectors = model.encode([
    "BrandA Cristal 1L | marca: BRANDA | tipo: CERVEZAS | formato: RETORNABLE 1000",
    "BrandB Lata 473 | marca: BRANDB | tipo: CERVEZAS | formato: LATA 473",
...
# Synthetic catalog — same shape as real ACME products
brands = ["BRANDA", "BRANDB", "STELLA", "HEINEKEN", "SUPPLIERA", "BUDWEISER",
