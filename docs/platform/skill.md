...
Prompt modules injected:
1. **`system/colloquial-vocabulary`** — known mappings and heuristics for common Argentine informal product references (e.g., "la rubia" → BrandA lager, "cajón" → case of bottles)
