...
Módulos de prompts inyectados:
1. **`system/colloquial-vocabulary`** — mapeos conocidos y heurísticas para referencias informales comunes de productos argentinos (ej. "la rubia" → BrandA clásica, "cajón" → cajón retornable de botellas).
