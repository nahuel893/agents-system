...
**agents-system** is a production-grade multi-agent platform designed to automate WhatsApp-based sales conversations using LLMs. It began as a custom sales agent for [a regional beverage distributor](https://www.acme.com/) (a major beverage distributor in Argentina) and evolved into a reusable agent orchestration platform.
...
| **ACME Delivery** | Concrete company implementation — WhatsApp integration, LangGraph sales agent, RAG product matching, sync pipelines |
...
Built originally for **a regional beverage distributor** — its parent group.
