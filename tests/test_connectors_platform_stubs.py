...
def test_build_acme_registry_contains_all_eight_tools() -> None:
    from agentsys.connectors.stubs import build_acme_registry

    _assert_platform_tools(build_acme_registry())


def test_build_acme_rag_registry_contains_all_eight_tools() -> None:
