...
from acme.harness.loader import AgentDefinition
from acme.harness.registry import ToolRegistry, ToolSpec
...
def test_resolve_tool_surface_grants_all_tools_when_permissions_present() -> None:
    from acme.harness.injector import resolve_tool_surface
...
def test_resolve_tool_surface_raises_for_unregistered_tool() -> None:
    from acme.harness.injector import InjectionError, resolve_tool_surface
