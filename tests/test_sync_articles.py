...
from acme.models.tables import CatalogEmbedding
from acme.services.embeddings import FakeEmbeddingProvider
...
async def test_sync_articles_inserts_new(
    ...
    await _seed_medallion(
        medallion_engine,
        [
            {"id_articulo": 1, "des_articulo": "BrandA Cristal 1L",
             "marca": "BRANDA", "generico": "CERVEZAS", "calibre": "RETORNABLE 1000"},
            {"id_articulo": 2, "des_articulo": "BrandB Lata 473",
             "marca": "BRANDB", "generico": "CERVEZAS", "calibre": "LATA 473"},
...
async def test_sync_articles_updates_existing(
    ...
    async with _bot_session(bot_engine)() as bsess:
        ...
        assert "BrandA Cristal 1L" in rows[0].description
...
async def test_sync_articles_skips_empty_description(
    ...
    await _seed_medallion(
        medallion_engine,
        [
            {"id_articulo": 1, "des_articulo": "BrandA 1L", "marca": "Q", "generico": "C", "calibre": "R"},
