"""Tests for the agent definition loader (src/acme/harness/loader.py).
...
def _generic_roots() -> Any:
    ...
    from acme.harness.loader import RootConfig
...
def test_load_generic_produces_agent_definition() -> None:
    from acme.harness.loader import AgentDefinition, resolve
...
def test_load_generic_tools_parsed() -> None:
    from acme.harness.loader import resolve
...
def test_override_tool_not_in_parent_raises_definition_error() -> None:
    from acme.harness.loader import DefinitionError, resolve
