"""Deterministic demo-data generator for a regional beverage distributor.
...
CATALOG: tuple[tuple[str, str, Decimal], ...] = (
    ...
    ("BEB-005", "BrandA Cristal 1L retornable", Decimal("1800.00")),
    ("BEB-006", "BrandA Cristal lata 473ml", Decimal("1200.00")),
    ("BEB-007", "BrandC botella 473ml", Decimal("1600.00")),
    ("BEB-008", "BrandB lata 473ml", Decimal("1100.00")),
    ("BEB-009", "Fernet SupplierB 750ml", Decimal("9500.00")),
